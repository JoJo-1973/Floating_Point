; BASIC Floating Point macros
; (c) 2024 Stefano Priore

INDEX           = $22               ; Pointer used by BASIC FP routines
USRADD          = $0311             ; USR function vector

FAC1            = $61               ; Floating Point Accumulator #1 & parts
FAC1_EXP        = FAC1              ; Exponent in excess-$80 format
FAC1_MANT       = FAC1+1            ; 32-bit Mantissa
FAC1_SIGN       = FAC1+5            ; Sign in bit #7 (0=+, $FF=-)
FAC1_ROUND      = $70               ; FAC1 rounding byte

FAC2            = $69               ; Floating Point Accumulator #2 & parts
FAC2_EXP        = FAC2              ; Exponent in excess-$80 format
FAC2_MANT       = FAC2+1            ; 32-bit Mantissa
FAC2_SIGN       = FAC2+5            ; Sign in bit #7 (0=+, 1=-)

ARISGN          = $6F               ; Product of signs of FAC1 and FAC2 in bit #7 (0=like signs, 1=unlike signs)
SCRATCHPAD      = $57               ; BASIC numeric work area. Overwritten by FP routines, can be used as scratchpad between calcs
SCRATCHPAD2     = $4E               ;
                                    ; This way both FACs can be stored temporarily if there's a subroutine that unexpectedly affect them

CHRGOT          = $79               ; Re-read current character in input stream
TXTPTR          = $7A               ; Pointer of the character processed by CHRGET/CHRGOT
!set STROUT     = $AB1E             ; Print string pointed by .Y/.A --- WARNING! IT DESTROYS FAC1
PIVAL           = $AEA8             ; Constant PI in MEMORY format
GIVAYF          = $B391             ; Convert a 16-bit value in .Y/.A to FP and store it in FAC1
FSUBT           = $B853             ; FAC1 = FAC2 - FAC1
FADDT           = $B86A             ; FAC1 = FAC2 + FAC1
FMULTT          = $BA2B             ; FAC1 = FAC2 * FAC1
CONUPK          = $BA8C             ; Copy from memory to FAC2
TENC            = $BAF9             ; Constant 10 in MEMORY format
FDIVT           = $BB12             ; FAC1 = FAC2 / FAC1
MOVFM           = $BBA2             ; Copy from memory to FAC1
MOVMF           = $BBD4             ; Copy FAC1 to memory
ROUND           = $BC1B             ; Round FAC1 depending on the value of FAC1_ROUND
SIGN            = $BC2B             ; Return sign of FAC1 in .A
FIN             = $BCF3             ; Convert string in $7A/$7B to FAC1
FOUT            = $BDDD             ; Convert FAC1 to string at $0100
FHALF           = $BF11             ; Constant 1/2 in MEMORY format
PI2             = $E2E0             ; Constant PI/2 in MEMORY format
TWOPI           = $E2E5             ; Constant 2*PI in MEMORY format
FR4             = $E2EA             ; Constant 1/4 in MEMORY format
