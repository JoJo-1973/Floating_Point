...
; Title:                  MACRO: Return the sign of a floating point number and store the result in FAC
; Name:                   SGN_FAC
;                         SGN_ARG
;                         SGN_Mem
;                         SGN_Ptr
; Description:            Return the sign of a Microsoft Binary Format floating point number and store the result in FAC.
;                         SGN_ARG is an exception because it operates in place rather than storing the result in FAC.
;                         The data can be located in FAC, in ARG, at an absolute memory address or referenced to by a pointer.
;                           FAC = -1 if data < 0.
;                           FAC = 0 if data = 0.
;                           FAC = 1 if data > 0.
